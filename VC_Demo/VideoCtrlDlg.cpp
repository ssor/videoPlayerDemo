...
void CVideoCtrlDlg::OnVcReset() 
{
	...
	NAME(VN_PLAY_SetColor)(m_lPort, 0, COLOR_DEFAULT, COLOR_DEFAULT, COLOR_DEFAULT, COLOR_DEFAULT);
}
...
void CVideoCtrlDlg::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	...
	case IDC_SLIDER_HUE:
		...
		NAME(VN_PLAY_SetColor)(m_lPort, 0, nBrightness, nContrast, nSaturation, nHue);
